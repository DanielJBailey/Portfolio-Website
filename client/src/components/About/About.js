...
const About = () => {
   return (
      <AboutContainer>
         ...
         <Bio>
            After working in the banking industry for a few years after college,
            I decided to pursue an exciting and challenging career in software
            ...
            City, UT. I am currently a student at Dev Point Labs and will
            graduate from the University of Utah partnered program in February
            of 2019.
         </Bio>
         <Bio>
            ...
            people with similair interests. I get excited about helping others
            learn how to code, and see them get excited about things they are
            able to build. I love to be challenged every day whether it be a new
            algorithm challenge or designing and developing an application with
         ...
         <Bio>
            ...
            restaurant, or exploring the outdoors with my amazing wife Jess and
            my goofy golden retriever named Riggs.
         </Bio>
      </AboutContainer>
   );
};
